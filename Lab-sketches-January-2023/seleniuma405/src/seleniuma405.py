...
def logger(): # GenesisGir's typical logger preset! 🪵
    ...
    filename = r"Scrap-Yard\Lab-sketches-January-2023\seleniuma405\loggenesisgir-logger.log",
    mode = 'w', # filemode 
...
# collect url data with open()
with open(r'Scrap-Yard\Lab-sketches-January-2023\seleniuma405\data\url.txt','r') as f:
    url_data = f.read()
    pass
...
# driver instance from chrome class from webdriver()
driver = webdriver.Chrome(executable_path=r'Scrap-Yard\Lab-sketches-January-2023\seleniuma405\driver\chromedriver.exe',
                            service_log_path=r'Scrap-Yard\Lab-sketches-January-2023\seleniuma405\log\service-logger.log',
                            options=options)
...
def open_browser():
    ...
    # open uniform resource locator/maximize window!
    driver.get(url_data)
